...
\definecolor{secondary}{RGB}{13,71,161}

\title{\vspace{-0.5cm}\textbf{\LARGE COL 7364: Assignment 1 Final Report}\\\textbf{\Large Sparse Retrieval Arena: Inverted Indexing, Vector Space Models, and Clinical BM25F Tuning on TREC-COVID}}
...
\end{equation}
where the Robertson-Sp\"arck Jones smoothed IDF formulation is calculated as:
\begin{equation}
